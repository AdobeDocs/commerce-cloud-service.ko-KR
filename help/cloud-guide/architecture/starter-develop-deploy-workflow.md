...
- 저장소 관리자 액세스, 이름, 언어, 통화, 브랜딩, 사이트, 저장소 보기 등에 대한 [기본 구성](https://docs.magento.com/user-guide/configuration/configuration-basic.html)
- CSS와 레이아웃을 포함한 사이트 및 스토어의 모양과 느낌을 위한 [테마](https://docs.magento.com/user-guide/design/design-theme.html)
- 데이터베이스의 역할, 도구, 알림 및 암호화 키에 대한 [시스템 구성](https://docs.magento.com/user-guide/system/system.html)
- 해당 설명서를 사용한 확장 설정
...
- 데이터를 생성하고 내보내는 [데이터 수집](https://docs.magento.com/user-guide/system/support-data-collector.html) 도구
