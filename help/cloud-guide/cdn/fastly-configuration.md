...
1. 다음에서 _캐싱 응용 프로그램_ 섹션, 선택 항목 제거 **시스템 값 사용**&#x200B;을 선택한 다음 을 선택합니다 **Fastly CDN** 을 클릭합니다.
...
1. CNAME 레코드를 추가하여 사전 프로덕션 URL을 Fastly 서비스로 지정합니다. `prod.magentocloud.map.fastly.net`, 예를 들면 다음과 같습니다.
